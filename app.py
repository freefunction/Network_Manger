            ...
            if st.session_state.routes_loaded:
                ...
                for route_id, route in manager.routes.items():
                    ...
                    routes_data.append({
                        ...
                        '100G Traffic': route.traffic.get(TrafficType.G100, 0),
                        '10G Traffic': route.traffic.get(TrafficType.G10, 0),
                        '1G Traffic': route.traffic.get(TrafficType.G1, 0),
        ...
        with tab3:
            if st.session_state.routes_loaded:
                ...
                for route_id, route in manager.routes.items():
                    export_data.append({
                        'Route': route_id,
                        '100G': route.traffic.get(TrafficType.G100, 0),
                        '10G': route.traffic.get(TrafficType.G10, 0),
                        '1G': route.traffic.get(TrafficType.G1, 0)
                    })
                ...
                st.download_button(
                    ...
                    file_name="network_routes_export.xlsx",
